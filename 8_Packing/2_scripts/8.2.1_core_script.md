...
video_script:
  ...
  prompt: 
    ...
    - Format Template: 
      [LO#-V##: TITLE WITH EMOJI]
      TITLE: Topic name written in all caps, optionally followed by relevant emojis to signal theme or tone
      Context / Introduction (1st paragraph):
      [SHOW]
      [DO]
      [CLOSING]  
```
