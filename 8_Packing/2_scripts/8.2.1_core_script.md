...
Lo1-v1-s1-Setup pick environment-tell-show 
...
LO1-v1-SettingUpEnvironment-tell
For most of the student to be able to access it needs to be virtulised. Setting up the environment is our gaoil. This is the main task.We should focus on it in way that we can rebuild it with ease. It is a about becoming M skilled and i was not in that positigon and looking for easy cuts not iu realise this is one of the hard ways but meainingful way to build it. The sysytem we are buulding would have the hardest time to stay online. And give us more clues to learn . So my proof of concept choice in on linux and cloud based called ode spaces and there is a great community behind it. As a side quest we are a bit of Yak shaving this Kubernetes and Cloud based vision would pay of for the IT professionals in the long run. Trust me i was there objecting to this.
