...
Intro-S5-portfolio
Checkout linkedin for the projects and contracts that are mentioned here. Also go to the github where i am sharing all the code that is needed for this course and check out the portfolio projects over there. Building a portfolio in Github matters and SonarQube would complement it by making sure the quality of the software is meeting the requirements for the customers that are seeking easily updatable applications.
