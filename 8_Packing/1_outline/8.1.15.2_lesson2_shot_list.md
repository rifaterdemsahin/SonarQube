...
Create a table in markdown with columns for:
...
- **Link to Reading/Video Script**   : Every Link to Reading/Video Script should include relevant  open source articles for the Link to reading 
